...
enum class SettingsNavItem(
    ...
    GOOGLE(
        R.id.main_menu_google,
        Icons.Outlined.AccountCircle,
        R.string.google_cloud_google,
        NavSection.ACCOUNTS
    ),

    STORES(
        R.id.main_menu_stores,
        Icons.Outlined.ShoppingBag,
        R.string.stores_accounts_title,
        NavSection.ACCOUNTS
    ),
    ...
    PRESETS(
        ...
        Icons.Outlined.Tune,
        R.string.container_presets_title,
        NavSection.SYSTEM
    ),

    COMPONENTS(
        R.id.main_menu_contents,
        Icons.Outlined.Extension,
        R.string.settings_content_components,
        NavSection.SYSTEM
    ),

    DRIVERS(
        R.id.main_menu_adrenotools_gpu_drivers,
        Icons.Outlined.Memory,
        R.string.settings_drivers_title,
        NavSection.SYSTEM
    ),
    ...
    INPUT_CONTROLS(
        ...
        R.string.common_ui_input_controls,
        NavSection.SYSTEM
    ),

    OTHER(
        R.id.main_menu_other,
        Icons.Outlined.Widgets,
        R.string.common_ui_other,
        NavSection.SYSTEM
    ),

    DEBUG(
        R.id.main_menu_advanced,
    ...
    CREDITS(
        R.id.main_menu_credits,
        Icons.Outlined.Info,
        R.string.retro_scr_tab_credits,
        NavSection.CREDITS
    );

    companion object {
        fun fromMenuId(id: Int): SettingsNavItem? =
            entries.find { it.menuId == id }
    }
}
...
fun SettingsNavSidebar(
    ...
    val navStartInset =
        navBarPadding.calculateStartPadding(layoutDirection)
    ...
    val selectedLazyIndex =
        remember(selectedItem) {
            ...
            NavSection.entries.forEachIndexed { sIdx, section ->
                ...
                val secItems =
                    sectionedNavItems[section].orEmpty()

                val pos =
                    secItems.indexOf(selectedItem)
    ...
    LaunchedEffect(selectedLazyIndex) {
        ...
        if (!fullyVisible) {
            runCatching {
                listState.scrollToItem(selectedLazyIndex)
            }
        }
    }
    ...
    Row(
        ...
        modifier =
            Modifier
                ...
                // Removed Modifier.border()
                // No androidx.compose.foundation.border required.
